...
@pytest.mark.django_db()
def test_fs_delete():
    obj = factory.IncomingTransferableFactory(id=UUID("a8fcc4dd-4448-42f0-b678-a99ae8a8189a"))
...
def test_fs_append_bytes():
    obj = factory.IncomingTransferableFactory(id=UUID("a8fcc4dd-4448-42f0-b678-a99ae8a8189b"))
